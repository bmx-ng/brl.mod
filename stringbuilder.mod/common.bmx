...
Extern
	...
	Function bmx_stringbuilder_split_ints:Int[](buffer:Byte Ptr, separator:String)
	Function bmx_stringbuilder_split_bytes:Byte[](buffer:Byte Ptr, separator:String)
	Function bmx_stringbuilder_split_shorts:Short[](buffer:Byte Ptr, separator:String)
	Function bmx_stringbuilder_split_uints:UInt[](buffer:Byte Ptr, separator:String)
	Function bmx_stringbuilder_split_longs:Long[](buffer:Byte Ptr, separator:String)
	Function bmx_stringbuilder_split_ulongs:ULong[](buffer:Byte Ptr, separator:String)
